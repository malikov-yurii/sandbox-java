...
class T1_IsUniqueCharsStrTest {

    @Test
    void testAllCharsUnique_V4() {
        assertThat(T1_IsUniqueCharsStr.isAllCharsUniqueV4(TestUtil.UNIQUE_CHAR_STR))
                .as(TestUtil.UNIQUE_CHAR_STR)
                .isTrue();
        assertThat(T1_IsUniqueCharsStr.isAllCharsUniqueV4(TestUtil.NON_UNIQUE_CHAR_STR))
                .as(TestUtil.NON_UNIQUE_CHAR_STR)
                .isFalse();
    }
    @Test
    void testAllCharsUnique_V3() {
        assertThat(T1_IsUniqueCharsStr.isAllCharsUniqueV3(TestUtil.UNIQUE_CHAR_STR))
                .as(TestUtil.UNIQUE_CHAR_STR)
                .isTrue();
        assertThat(T1_IsUniqueCharsStr.isAllCharsUniqueV3(TestUtil.NON_UNIQUE_CHAR_STR))
                .as(TestUtil.NON_UNIQUE_CHAR_STR)
                .isFalse();
    }
    ...
    void testAllCharsUnique_V2() {
        assertThat(T1_IsUniqueCharsStr.isAllCharsUniqueV2(TestUtil.UNIQUE_CHAR_STR))
                .as(TestUtil.UNIQUE_CHAR_STR)
                .isTrue();
        assertThat(T1_IsUniqueCharsStr.isAllCharsUniqueV2(TestUtil.NON_UNIQUE_CHAR_STR))
                .as(TestUtil.NON_UNIQUE_CHAR_STR)
                .isFalse();
    }
    ...
    void testAllCharsUnique_V1() {
        assertThat(T1_IsUniqueCharsStr.isAllCharsUniqueV1(TestUtil.UNIQUE_CHAR_STR))
                .as(TestUtil.UNIQUE_CHAR_STR)
                .isTrue();
        assertThat(T1_IsUniqueCharsStr.isAllCharsUniqueV1(TestUtil.NON_UNIQUE_CHAR_STR))
                .as(TestUtil.NON_UNIQUE_CHAR_STR)
                .isFalse();
    }
...
//        String longString = TestUtil.generateUniqueCharStringUnordered(30_500);
        ...
        TestUtil.executeTaskMultipleTimes("V1", runCount,
                () -> T1_IsUniqueCharsStr.isAllCharsUniqueV1(longString));
        TestUtil.executeTaskMultipleTimes("V2", runCount,
                () -> T1_IsUniqueCharsStr.isAllCharsUniqueV2(longString));
        TestUtil.executeTaskMultipleTimes("V3", runCount,
                () -> T1_IsUniqueCharsStr.isAllCharsUniqueV3(longString));
        TestUtil.executeTaskMultipleTimes("V4", runCount,
                () -> T1_IsUniqueCharsStr.isAllCharsUniqueV4(longString));
    }
