...
public class T_4_10_CheckSubtreeDFS {
    ...
    public static <T> boolean containsSubtree(TreeNode<T> big, TreeNode<T> small) {
        return small == null || checkSubtree(big, small);
    }

    public static <T> boolean checkSubtree(TreeNode<T> big, TreeNode<T> small) {
        return big != null && (equals(big, small) || checkSubtree(big.left, small) || checkSubtree(big.right, small));
    }

    private static <T> boolean equals(TreeNode<T> first, TreeNode<T> second) {
